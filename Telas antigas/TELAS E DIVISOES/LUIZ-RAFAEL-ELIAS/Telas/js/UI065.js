var numeroCampos = 5; <!-- INSIRA O NÚMERO DE CAMPOS -->
...
/* Exemplos:
	...
	validaChar("idfreteJ", regexNUMEROS, 0);
	validaChar("idveiculoJ", regexNUMEROS, 1);
	validaChar("idmotoristaJ", regexNUMEROS, 2);
	validaChar("idtransportadorJ", regexNUMEROS, 3);
	validaChar("idcargaJ", regexNUMEROS, 4);
	validaChar("tempoviagemJ", regexNUMEROS, 5);
