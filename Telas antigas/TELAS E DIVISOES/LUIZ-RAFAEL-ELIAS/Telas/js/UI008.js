var numeroCampos = 7; <!-- INSIRA O NÚMERO DE CAMPOS -->
...
/* Exemplos:
	...
	validaChar("idveiculoJ", regexNUMEROS, 0);
	validaChar("placaJ", regexPLACA, 1);
	validaChar("idmodeloJ", regexNUMEROS, 2);
	validaChar("corJ", regexLETRAS, 3);
	validaChar("anofabricacaoJ", regexNUMEROS, 4);
	validaChar("numeroeixosJ", regexNUMEROS, 5);
	validaChar("pesobrutoJ", regexNUMEROS, 6);
	validaChar("idtransportadorJ", regexNUMEROS, 7);
