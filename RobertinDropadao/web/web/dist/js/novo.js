...
/*INICIO BUSCAR ENDEREÇO*/
function getEndereco(cep) {
    if($.trim(cep) != ""){
        //$("#loadingCep").html('Pesquisando...');
        $.getScript("http://cep.republicavirtual.com.br/web_cep.php?formato=javascript&cep="+cep, function(){            
            if (resultadoCEP["resultado"] != 0) {
                $("#cidadeJ").val(unescape(resultadoCEP["cidade"]));
                $("#ufJ").val(unescape(resultadoCEP["uf"]));
		$("#logradouroJ").val(unescape(resultadoCEP["logradouro"]));
                $("#tipoLogradouroJ").val(unescape(resultadoCEP["tipo_logradouro"]));
                $("#bairroJ").val(unescape(resultadoCEP["bairro"]));
            }else{
...
var x = _gbc("tSpan");/*class de todas as tags span*/
        ...
        /*CHAMANDO A FUNÇÃO DE BUSCAR CEP*/
        _$("cepJ").onblur = function x(){
            getEndereco($("#cepJ").val());
        }
        /*FIM BUSCAR CEP*/
        
        _$("nomeJ").onblur = function y(){
           nozes("nomeJ");
        }
