<%-- 
    Document   : ui015consultarrodovia
    Created on : 22/10/2015, 00:10:07
    Author     : Luiz
--%>
...
<html lang="pt-br">
    <head>
        <title>Consultar Rodovia | DigiMon</title>
        ...
        <div id="interface">
            ...
            <div id="main">
                <div class="centro">
                    ...
                    <form action="ServletUI015" method="post" id="formularioJ">
                        <fieldset>
                            ...
                            <div class="campo"> 
                                ...
                                <input type="text" name="nome" id="nomeJ" class="campoObrig"  size="30" maxlength="40" ><span id="x_nomeJ" class="tSpan"></span>
                            </div><!--Fim campo nomeJ-->
                            <div class="campo"> 
